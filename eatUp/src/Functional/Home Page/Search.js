...
const Search = ({navigation}) => {
  ...
  const locationSearchFilterIcon = searchLocations ? "flag-variant" : "flag-variant-outline";
  const tagSearchFilterIcon = searchTags ? "tag-multiple" : "tag-multiple-outline";
